...
export const TEAMS: TeamInfo[] = [
  { code: "LG", name: "LG 트윈스", shortName: "LG", color: "#C30452" },
  { code: "KT", name: "KT 위즈", shortName: "KT", color: "#000000" },
  { code: "SK", name: "SSG 랜더스", shortName: "SSG", color: "#CE0E2D" },
  { code: "NC", name: "NC 다이노스", shortName: "NC", color: "#1D467F" },
  { code: "OB", name: "두산 베어스", shortName: "두산", color: "#1A1748" },
  { code: "HT", name: "KIA 타이거즈", shortName: "KIA", color: "#EA0029" },
  { code: "LT", name: "롯데 자이언츠", shortName: "롯데", color: "#041E42" },
  { code: "SS", name: "삼성 라이온즈", shortName: "삼성", color: "#074CA1" },
  { code: "HH", name: "한화 이글스", shortName: "한화", color: "#FC4E00" },
  { code: "WO", name: "키움 히어로즈", shortName: "키움", color: "#570514" },
];
